...
## Overview
The `validate_emails.py` is a Python-based tool for email verification and email validation that allows you to classify your email addresses' status using syntax, DNS, and SMTP (Simple Mail Transfer Protocol) and other checks and 3rd party APIs. Using the script's returned status classifications, you can then clean or scrub your email lists. This can be done self-hosted locally on a server or via the supported [commercial email verification service APIs](#api-support) ([jump straight to email verification provider API speed and result benchmarks](#email-verification-provider-api-speed-benchmarks)). The script's [API Merge support](#api-merge) also allows you to combine 2 API email verification providers results into one JSON formated output for double verification checks. The script provides a convenient way to verify the existence and deliverability of email addresses, helping you maintain a clean and accurate email list.
...
- Reoon as added on May 12, 2024 and per email verification API should be kept at [less than 5 concurrent threads](https://www.reoon.com/articles/api-documentation-of-reoon-email-verifier/). They say they take around 20 minutes to verify a set of 50,000 mixed-quality email addresses. For bulk email API, max is 50,000 emails per list. A bit on the low side given some other providers allow a max 1 million emails per list. The 15 email address sameple test took 2.176 seconds to complete.
...
- Given the results of the [Email Verification Provider API Speed Benchmarks](#email-verification-provider-api-speed-benchmarks) and my [personal experiences](#personal-experience), the top 4 contenders for me personally would be: [Zerobounce](https://centminmod.com/zerobounce), [MillionVerifier](https://centminmod.com/millionverifier), [EmailListVerify](https://centminmod.com/emaillistverify) and [Reoon](https://centminmod.com/reoon). Notes: 
    - Reoon bulk email API only supports max 50,000 email addresses per list. So if you have 500,000 email addresses to verify, you'd need to use their bulk email API to upload 10x 50K email list files.
    - ZeroBounce says they have [no limits for bulk email API file sizes or email addresses](https://www.zerobounce.net/docs/email-validation-api-quickstart/#send_file__v2__). However, they also mention if you have email lists [5+ million in size to contact them](https://www.zerobounce.net/docs/#validation-process-faqs) and they mention for a email list of 100,000 emails it can take between [1 - 3 hours to validate](https://www.zerobounce.net/docs/frequently-asked-questions/potential-issues/why-is-my-file-taking-so-long-to-process/).
    - EmailListVerify allows to up to [1 million emails per list](https://www.emaillistverify.com/docs/#section/File-Verification).
    - MillionVerifier allow for a [maximum 2 simultaneous bulk file API uploads at a time](https://help.millionverifier.com/bulk-email-verification/verify-multiple-files-at-the-same-time) and max size of files uploaded are [1 million emails per file or 100MB size](https://help.millionverifier.com/bulk-email-verification/upload-emails-for-verification). If each of the files contains more than 1000 emails, they will verify a maximum of 2 files at a time.
- [MillionVerifier](https://centminmod.com/millionverifier) would nearly get the best overall for performance to price ratio, but its sometimes inaccurate classification for valid Yahoo email addresses means you can't rely on it for Yahoo emails at least. Still it's cheap, so you could run all non-Yahoo email addresses through [MillionVerifier](https://centminmod.com/millionverifier) and separately run Yahoo email addresses through [EmailListVerify](https://centminmod.com/emaillistverify) and still work out cheaper than using [Zerobounce](https://centminmod.com/zerobounce). My `validate_emails.py` script would make such verifications easy to do as it supports multiple email verification API providers in a single script :sunglasses: Though [Zerobounce](https://centminmod.com/zerobounce) has the [fastest API response times](#email-verification-provider-api-speed-benchmarks).

| Provider | 1k | 2k | 5k | 10k | 25k | 30k | 50k | 70k | 100k |
|----------------------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [EmailListVerify](https://centminmod.com/emaillistverify) ([demo](#emaillistverify-1), [results](#email-verification-provider-api-speed-benchmarks)) | $4 (0.0008) :heavy_dollar_sign: | - | $15 (0.003) :heavy_dollar_sign:| $24 (0.0024)| $49 (0.00196)| - | $89 (0.00178)| - | $169 (0.00169)|
| [MillionVerifier](https://centminmod.com/millionverifier) ([demo](#millionverifier), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | - | $37 (0.0037)| $49 (0.00196)| - | $77 (0.00154)| - | $129 (0.00129)|
| [MyEmailVerifier](https://centminmod.com/myemailverifier) ([demo](#myemailverifier-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | $14 (0.007) :heavy_dollar_sign:| $28 (0.0056)| $39 (0.0039)| $79 (0.00316)| - | $149 (0.00298)| - | $239 (0.00239)|
| [CaptainVerify](https://centminmod.com/captainverify) ([demo](#captainverify-api), [results](#email-verification-provider-api-speed-benchmarks)) | $7 (0.007) | - | $30 (0.006) | $60 (0.006) | $75 (0.003) | - | $150 (0.003) | - | $200 (0.002) |
| [Proofy.io](https://centminmod.com/proofy) ([demo](#proofy-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | $16 (0.0032)| $29 (0.0029)| - | $63 (0.0021)| $99 (0.00198)| $124 (0.00177)| $149 (0.00149)|
| [Zerobounce](https://centminmod.com/zerobounce) ([demo](#zerobounce-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | $20 (0.01) | $45 (0.009) | $80 (0.008) | $190 (0.0076) | - | $375 (0.0075) | - | $425 (0.00425) |
| [Reoon](https://centminmod.com/reoon) ([demo](#reoon-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | - | $11.91 (0.00119) :heavy_dollar_sign: | $29.66 (0.00119) :heavy_dollar_sign: | - | $58.95 (0.00118) :heavy_dollar_sign: | $87.86 (0.00126) :heavy_dollar_sign: | $116.40 (0.00116) |
| [Bouncify](https://centminmod.com/bouncify) ([demo](#bouncify-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | - | $19 (0.0019) | - | $39 (0.0013) :heavy_dollar_sign: | - | - | $99 (0.001) :heavy_dollar_sign: |
| [Bounceless](https://centminmod.com/bounceless) ([demo](#bounceless-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | $29 (0.0058) | - | $99 (0.00396) | - | - | - | $299 (0.00299) |

| Provider | 200k | 250k | 300k | 500k | 1m | 2.5m | 5m | 10m |
|----------------------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [EmailListVerify](https://centminmod.com/emaillistverify) ([demo](#emaillistverify-1), [results](#email-verification-provider-api-speed-benchmarks)) | - | $349 (0.001396)| - | $449 (0.000898)| $599 (0.000599)| $1190 (0.000476) :heavy_dollar_sign:| $1990 (0.000398)| $3290 (0.000329)|
| [MillionVerifier](https://centminmod.com/millionverifier) ([demo](#millionverifier), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | - | $259 (0.000518) :heavy_dollar_sign:| $389 (0.000389) :heavy_dollar_sign:| - | $1439 (0.000288) :heavy_dollar_sign:| $2529 (0.000253) :heavy_dollar_sign:|
| [MyEmailVerifier](https://centminmod.com/myemailverifier) ([demo](#myemailverifier-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | $349 (0.001396)| - | $549 (0.001098)| $749 (0.000749)| $1249 (0.0005) | $1849 (0.00037)| - |
| [CaptainVerify](https://centminmod.com/captainverify) ([demo](#captainverify-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | $250 (0.001) :heavy_dollar_sign: | - | $500 (0.001) | $650 (0.00065)| - | $2000 (0.0004) | - |
| [Proofy.io](https://centminmod.com/proofy) ([demo](#proofy-api), [results](#email-verification-provider-api-speed-benchmarks)) | $229 (0.001145)| - | $289 (0.000963) :heavy_dollar_sign:| $429 (0.000858)| $699 (0.000699)| $1399 (0.00056)| - | - |
| [Zerobounce](https://centminmod.com/zerobounce) ([demo](#zerobounce-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | $940 (0.00376) | - | $1800 (0.0036) | $2750 (0.00275) | - | - | - |
| [Reoon](https://centminmod.com/reoon) ([demo](#reoon-api), [results](#email-verification-provider-api-speed-benchmarks)) | $226.80 (0.00113) | $279.75 (0.00112) | $331.20 (0.00110) | $522.00 (0.00104) | $960.00 (0.00096) | - | - | - |
| [Bouncify](https://centminmod.com/bouncify) ([demo](#bouncify-api), [results](#email-verification-provider-api-speed-benchmarks)) | $149 (0.00075) :heavy_dollar_sign: | - | - | $279 (0.00056) | $479 (0.00048) | - | - | - |
| [Bounceless](https://centminmod.com/bounceless) ([demo](#bounceless-api), [results](#email-verification-provider-api-speed-benchmarks)) | - | - | - | $649 (0.001298) | $899 (0.000899) | - | - | - |
...
- Zerobounce and MillionVerifier are the fastest email verification API providers in terms of both average and maximum API response times. Zerobounce's average API response times was held back by slow `user@yahoo.com` verification check at `1.0279`seconds (though it was still the fastest API response time that had an accurate `status`). MillionVerifier's average API response times was held back by several checks >0.5 seconds with slowest `user@tempr.email` verification checks `0.5481` seconds.
...
- `user@yahoo.com` known valid Yahoo email address that is working. MilliomVerifier Yahoo email address incorrect `unknown` labeling showed up in this specific test. According to [MillionVerifier support](#millionverifier-yahoo-email-address) this can happen on some of the API servers and/or if you test an email multiple times.

Notes:

- For `status` results that I know are incorrect, I've marked them with :x: next to the result.
- For `api_response_time` added :trophy: for fastest times for each email verification. For `user@yahoo.com` the fastest inaccurate and accurate results were both marked.
...
| 123@domain1.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.4128 :trophy: | no | no | thread-pool-0_5 | 2.930 |
...
| abc@domain1.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.259 :trophy: | no | no | thread-pool-0_4 | 2.930 |
...
| info@domain2.com | [zerobounce](https://centminmod.com/zerobounce) | do_not_mail | 0.3873 :trophy: | no | no | thread-pool-0_9 | 2.930 |
...
| op999@gmail.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.3605 :trophy: | yes | no | thread-pool-0_11 | 2.930 |
...
| pip@domain1.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.3377 :trophy: | no | no | thread-pool-0_7 | 2.930 |
...
| pop@domain1.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.3464 :trophy: | no | no | thread-pool-0_6 | 2.930 |
| user+to@domain1.com | [bouncify](https://centminmod.com/bouncify) | deliverable | 2.6186 | no | no | thread-pool-0_2 | 181.576 |
| user+to@domain1.com | [captainverify](https://centminmod.com/captainverify) | invalid :x: | 0.6153 | no | no | thread-pool-0_2 | 22.836 |
...
| user+to@domain1.com | [zerobounce](https://centminmod.com/zerobounce) | valid | 0.3708 :trophy: | no | no | thread-pool-0_2 | 2.930 |
...
| user1@outlook.com | [zerobounce](https://centminmod.com/zerobounce) | valid | 0.3327 :trophy: | yes | no | thread-pool-0_13 | 2.930 |
| user2@hotmail.com | [bouncify](https://centminmod.com/bouncify) | api_error :x: | 180.6231 | yes | no | thread-pool-0_14 | 181.576 |
...
| user2@hotmail.com | [zerobounce](https://centminmod.com/zerobounce) | valid | 0.3696 :trophy: | yes | no | thread-pool-0_14 | 2.930 |
...
| user@gmail.com | [zerobounce](https://centminmod.com/zerobounce) | valid | 0.3301 :trophy: | yes | no | thread-pool-0_10 | 2.930 |
...
| user@mailsac.com | [zerobounce](https://centminmod.com/zerobounce) | do_not_mail | 0.3632 :trophy: | yes | yes | thread-pool-0_0 | 2.930 |
...
| user@tempr.email | [zerobounce](https://centminmod.com/zerobounce) | do_not_mail | 0.3356 :trophy: | no | yes | thread-pool-0_8 | 2.930 |
| user@yahoo.com | [bouncify](https://centminmod.com/bouncify) | accept-all :x: | 0.7072 | yes | no | thread-pool-0_12 | 181.576 |
| user@yahoo.com | [captainverify](https://centminmod.com/captainverify) | invalid :x: | 0.597 | no | no | thread-pool-0_12 | 22.836 |
| user@yahoo.com | [emaillistverify](https://centminmod.com/emaillistverify) | valid | 1.3502 | yes | no | thread-pool-0_12 | 4.208 |
| user@yahoo.com | [millionverifier](https://centminmod.com/millionverifier) | unknown :x: | 0.5145 :trophy: | yes | no | thread-pool-0_12 | 1.614 |
...
| user@yahoo.com | [zerobounce](https://centminmod.com/zerobounce) | valid | 1.0279 :trophy: | yes | no | thread-pool-0_12 | 2.930 |
...
| xyz@centmil1.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.3171 :trophy: | no | no | thread-pool-0_1 | 2.930 |
...
| xyz@domain1.com | [zerobounce](https://centminmod.com/zerobounce) | invalid | 0.3335 :trophy: | no | no | thread-pool-0_3 | 2.930 |
