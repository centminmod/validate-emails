...
- <s>Proofy.io</s> only has single email check and batch email checks but no bulk file API support.
...
- Updates: 
  ...
  - June 24, 2026 refreshed both tables with current pay-as-you-go (one-time, non-expiring credit) pricing taken directly from each provider's live page, in USD. The tables remain PAYG-only; most providers now also sell a monthly subscription that is often cheaper per credit at the same volume. A few buckets fall outside the table columns: MillionVerifier now goes up to 50m ($8499), and Bouncify's entry bundle is 3k ($12). Proofy is priced via a calculator with fixed presets (1k–2.5m), so off-preset volumes are omitted. Most providers raised prices, with MyEmailVerifier the main exception (now the cheapest per credit at most volumes) and Bounceless unchanged since 2024.
...
|----------------------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [EmailListVerify](https://centminmod.com/emaillistverify) ([demo](#emaillistverify-1), [results](#email-verification-provider-api-speed-benchmarks)) | $5 (0.005) | - | $17 (0.0034)| $27 (0.0027)| $54 (0.00216)| - | $98 (0.00196)| - | $186 (0.00186)|
...
|----------------------------------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [EmailListVerify](https://centminmod.com/emaillistverify) ([demo](#emaillistverify-1), [results](#email-verification-provider-api-speed-benchmarks)) | - | $384 (0.00154)| - | $494 (0.00099)| $659 (0.00066)| $1309 (0.00052) :heavy_dollar_sign:| $2189 (0.00044)| $3620 (0.00036)|
